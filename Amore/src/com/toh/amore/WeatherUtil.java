...
public class WeatherUtil {
	...
	public WeatherInfo getCurrentWeatherByCityLatLon(Context context,
		...
		try {
			Gson gson = new Gson();
			model = gson.fromJson(weatherByGeoCo(context, lat, lon), WeatherInfo.class);
	...
	private String weatherByGeoCo(Context context,double lllat,double lllong)
			throws ClientProtocolException, IOException {
		Log.e("###","555");
		HttpClient httpClient = null;
		Log.e("###","666");
		...
		String lat2 = String.valueOf(lllat);
		String lon2 = String.valueOf(lllong);
		...
		if (statusCode == 200) {
			HttpEntity httpEntity = httpResponse.getEntity();
			String josnDataString = EntityUtils.toString(httpEntity);
			System.out.println("josnDataString"+josnDataString);
			return josnDataString;
		} else {
			return null;
		}
